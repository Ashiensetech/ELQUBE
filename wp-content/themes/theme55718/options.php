...
// ---------------------------------------------------------
			...
			$header_bg_defaults = array(
				'color' => '', 
				'image' => get_stylesheet_directory_uri() . '/images/bg_header.jpg', 
				'repeat' => 'repeat',
				'position' => 'top center',
				'attachment'=>'scroll'
			);
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#bcbcbc'));
			...
			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '30px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#363636'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '24px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#363636'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '30px', 'lineheight' => '39px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#808080'));
