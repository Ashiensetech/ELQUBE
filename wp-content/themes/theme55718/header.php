...
<body <?php body_class(); ?>>
	<div id="motopress-main" class="main-holder">
		...
		<div class="top_nav hidden-xs">
		    <div class="container">
		        <div class="row">
		            <div class="col-md-12 col-sm-12 ul_holder">
		                <ul class="top_nav_ul">
		                	<li class="other_li" style="font-size: 26px;"><a style=" color: #95c85a; font-size: 26px;" href="/my-account/"><i class="fa fa-sign-in"></i></a></li>
		                	<li class="other_li"><?php dynamic_sidebar( 'cart-holder' ); ?></li>
		                	<li class="currency_li"><?php dynamic_sidebar( 'currency-converter' ); ?></li>
		                	<li class="other_li"><?php get_template_part("static/static-shop-account"); ?></li>
		               		<div class="clear"></div>
		                </ul>
		                <div class="clear"></div>
		            </div>
		...
		<div class="top_nav visible-xs">
		    <div class="container">
			<div class="top_nav_holder">
		        	<div class="row">
		        		<div class="ul_holder ul_holder_icon">
		                		<a style=" color: #95c85a; font-size: 26px;" href="/my-account/"><i class="fa fa-sign-in"></i></a>
		                		<div class="clear"></div>
		            		</div>
		            		<div class=" ul_holder ul_holder_icon" >
		                		<?php dynamic_sidebar( 'cart-holder' ); ?>
		            		</div>
		            		<div class="ul_holder ul_holder_currency">
		                		<?php dynamic_sidebar( 'currency-converter' ); ?>
		            		</div>
		            		<div class="ul_holder ul_holder_icon">
